...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-lz-bg flex flex-col items-center justify-center px-6">
      ...
      <div className="flex flex-col gap-4 w-full max-w-xs">
        {/* Botão principal — Google OAuth (ativo quando Supabase estiver conectado) */}
        <button
          disabled
          className="bg-white border-2 border-gray-200 text-lz-black font-bold py-4 rounded-full text-base flex items-center justify-center gap-3 opacity-50 cursor-not-allowed"
        >
